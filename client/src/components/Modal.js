        ...
        <Fade in={open}>
          <div className={classes.paper}>
            {prod.length === 0 ? (
              ...
              <>
                <h1 className={classes.pageHeading}>Detail</h1>
                <div>
                  ...
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>CID Number Hash: </div>
                  ...
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Distributor Address: </div>{" "}
                    <div className={classes.dCol2}>{prod[1][6]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Distributor Longitude: </div>{" "}
                    <div className={classes.dCol2}>{prod[1][7]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Distributor Latitude: </div>{" "}
                    <div className={classes.dCol2}>{prod[2][0]}</div>
                  </div>

                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Agent Address:</div>{" "}
                    <div className={classes.dCol2}> {prod[2][1]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Agent Longitude: </div>{" "}
                    <div className={classes.dCol2}>{prod[2][2]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Agent Hub Latitude:</div>{" "}
