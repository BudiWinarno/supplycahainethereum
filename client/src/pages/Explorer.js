...
const columns = [
  { id: "id", label: "QR Code", minWidth: 170 },
  { id: "mname", label: "Manfacturer", minWidth: 170 },
  { id: "mdate", label: "Tanggal", minWidth: 170 },
  { id: "pname", label: "Nama Produk", minWidth: 170 },
  { id: "price", label: "Harga", minWidth: 170 },
  { id: "owner", label: "Pemilik", minWidth: 170 },
  { id: "lastAction", label: "Catatan", minWidth: 170 },
];

const map = [
  "Produksi Manufaktur",
  "Pembelian Oleh Distributor",
  "Pengiriman Oleh Manufaktur",
  "Penerimaan Oleh Distributor",
  "Pembelian Oleh Customer",
  "Pengiriman By Distributor",
  "Penerimaan Oleh Agent",
  "Pengiriman Oleh Agent",
  "Penerimaan Oleh Customer",
];
      ...
      <Navbar navItems={navItem}>
        {loading ? (
          ...
          <>
            ...
            />
            <h1 className={classes.pageHeading}>Pencarian Produk</h1>
            ...
            {productData.length !== 0 ? (
              <>
                ...
                <br />
                <h2 className={classes.tableCount}>Perjalanan Produk</h2>
